...
class sistemaAcademico(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.driver = webdriver.Chrome("C:/Users/victo/Documents/Github/testeUnitario/chromedriver.exe")
...
if __name__ == '__main__':
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output="C:/Users/victo/Documents/Github/testeUnitario/results"))
